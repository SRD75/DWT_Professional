	...
	<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
			...
			<div class="card-block">
				...
				<?php if ( 'post' === get_post_type() ) : ?>
					...
					<div class="entry-meta">
						<p class="card-text"> <?php dwt_professional_posted_on(); ?> </p>
					</div><!-- .entry-meta -->
		...
		<div class="card-block">
			<div class="entry-content card-text">
				<?php
				echo dwt_professional_excerpt_with_length( $post->ID, 15 );
				?>

				<?php
				wp_link_pages( array(
					'before' => '<div class="page-links">' . __( 'Pages:', 'dwt_professional' ),
					'after'  => '</div>',
				) );
				?>
			</div><!-- .entry-content -->
