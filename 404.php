				...
				<main class="site-main" id="main" role="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<?php if ( dwt_professional_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>

								<div class="widget widget_categories">

									<h2 class="widget-title"><?php _e( 'Most Used Categories', 'dwt_professional' ); ?></h2>
							...
							'dwt_professional' ), convert_smilies( ':)' ) ) . '</p>';
